...
4. **Extract Hooks** âš ï¸ GATE 1
   ...
   - Group related `useState` into custom hooks **APENAS SE REUSÃVEIS**
...
Output:
```
ðŸ” Uma: Analyzing CoursesTemplate.tsx...
...
ðŸ“ Creating structure: app/components/creator/courses/
...
ðŸ§ª TypeScript check...
  âœ“ npx tsc --noEmit: 0 errors

ðŸ“ Updated docs/refactoring/COMPONENT_REFACTORING_ROADMAP.md
