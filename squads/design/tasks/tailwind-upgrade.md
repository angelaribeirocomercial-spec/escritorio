...
- Target benchmarks (Catalyst reference):
  - Cold build â‰¤ 120ms (target <100ms)
  - Incremental (new CSS) â‰¤ 8ms
  - Incremental (no CSS) â‰¤ 300Âµs
...
- [ ] CSS bundle size â‰¤ previous production size (ideally <50KB gzipped)
