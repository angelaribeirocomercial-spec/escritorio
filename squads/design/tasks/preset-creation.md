...
INCLUDED SETTINGS:
âœ“ Tone Curve: [description]
âœ“ Color Grading: [shadows/highlights]
âœ“ HSL: [key adjustments]
âœ“ Grain: [amount/size/roughness]
âœ“ Vignette: [amount]
âœ“ Calibration: [if any]

EXCLUDED (adjust manually):
âœ— Exposure
âœ— White Balance
âœ— [any extreme values]
...
TEST RESULTS:
- Outdoor Daylight: âœ“ Pass
- Indoor Artificial: âœ“ Pass
- Backlit/High Contrast: âœ“ Pass
- Low Light/High ISO: âœ“ Pass
- Mixed Lighting: âœ“ Pass
- Skin Tones: âœ“ Protected
...
âœ“ Outdoor daylight - great
âœ“ Indoor window light - great
âœ“ Backlit portrait - good (adjust exposure)
âœ“ Low light street - good (grain stacks well)
âœ“ Mixed restaurant - good (WB first)

SKIN TONE TEST: âœ“ Natural
