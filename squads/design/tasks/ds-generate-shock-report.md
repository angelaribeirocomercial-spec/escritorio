...
7. **Create Before/After Preview**
   ...
   - Side-by-side comparison (47 buttons â†’ 3)
...
<body>
  <header>
    <h1>ðŸš¨ UI Pattern Chaos Report</h1>
  ...
  <section class="executive-summary">
    ...
    <ul>
      <li>81.8% pattern reduction possible (176 â†’ 32)</li>
...
Output:
```
ðŸ” Brad: Generating visual shock report...

ðŸ“¸ Extracting pattern examples...
  - Captured 47 button variations
  - Captured 89 color swatches
  - Captured spacing inconsistencies

ðŸ“Š Building metrics dashboard...
  - Pattern counts: âœ“
  - Reduction percentages: âœ“
  - ROI analysis: âœ“ ($374,400/year savings)

ðŸŽ¨ Creating horror show visualization...
  - Button grid: 47 variations displayed
  - Color explosion: 89 colors in grid
  - Spacing chaos: Visualized

âœ… Shock report generated: outputs/design-system/my-app/audit/shock-report.html

ðŸ‘€ Open in browser to see the horror show.
ðŸ“§ Share with stakeholders to drive action.
...
- Cost table: $457k â†’ $83k = $374k savings
