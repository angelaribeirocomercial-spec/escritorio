...
export function ClientCockpitFrame({
  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-[4px] border border-white/10 bg-white/[0.04] p-4">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">Modo da tela</p>
          <p className="mt-1 text-sm text-slate-300">
            {viewMode === "compact" ? "Cockpit compacto" : "Cockpit detalhado"}
          </p>
        </div>
