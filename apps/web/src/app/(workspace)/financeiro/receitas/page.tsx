  ...
  return (
    <div className="mj-model-page space-y-4">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div>
          <p className="mj-model-title">Receitas Operacionais</p>
        ...
        <div className="flex gap-2">
          ...
          <Link className="mj-model-button-green inline-flex items-center justify-center" href="/financeiro/receitas/novo">
            Adicionar
          </Link>
        </div>
      </div>

      <BalancePanel balance={getFinancialBalance(entries)} displayMode={selectedDisplay} entries={entries} />

      <form id="finance-filters-receitas" className="mj-model-toolbar grid gap-3 px-4 py-4 xl:grid-cols-[7rem_1fr_1.2fr_1fr_auto]" method="get">
        <div>
