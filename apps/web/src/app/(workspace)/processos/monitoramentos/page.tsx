...
export default async function ProcessosMonitoramentosPage({
  searchParams
}: {
  searchParams?: {
    q?: string;
  ...
  return (
    <div className="mj-model-page space-y-4">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div>
          <p className="mj-model-title">Monitoramentos</p>
      ...
      <div className="mj-model-soft-panel px-4 py-4 text-[13px] leading-6 text-slate-400">
        <p>Os monitoramentos derivam da mesma carteira processual aberta em `Processos`.</p>
      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_12rem]">
        ...
        <div className="mj-model-soft-panel px-4 py-4 text-[13px] leading-6 text-slate-400">
          ...
          <p className="mt-2">A leitura fica em `Processos` para evitar duplicacao entre carteira, acompanhamento e detalhe.</p>
        </div>
      </div>
